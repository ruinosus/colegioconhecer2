<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="colegioInfantil.aspx.cs" Inherits="colegioInfantil" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="corpo" runat="Server"> 
        ...
        <!-- Inicio do Conteúdo do Meio da Página -->
        	...
        	<div class="meio_artigos"><!-- Inicio do Artigo 1 a Meio da Página -->
              ...
              <div class="meio_artigos_texto_index3"><p><asp:Label ID="lblTextoArtigoMeio1" runat="server" /></p></div>
              ...
              <div class="meio_artigos_texto_index3"><p><asp:Label ID="lblTextoArtigoMeio2" runat="server" /></p></div>
              ...
              <div class="meio_artigos_texto_index6"><p><asp:Label ID="lblTextoArtigoMeio3" runat="server" /></p></div>
        ...
        <!-- Inicio do Conteúdo da Direita da Página -->
        	...
        	<div class="direita_artigos"><!-- Inicio do Artigo 1 a Direita da Página -->
              ...
              <div class="direita_artigos_imagem_index2"><asp:Image ID="imgArtigoDireita1" 
                      runat="server" Visible="false" Width="390" Height="130" /></div>
